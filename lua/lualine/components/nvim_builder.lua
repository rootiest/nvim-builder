...
---
---@module 'lualine.components.nvim_builder'
---

local arbitrary_thing_runner = require("nvim_builder._commands.arbitrary_thing.runner")
local configuration = require("nvim_builder._core.configuration")
local copy_log_runner = require("nvim_builder._commands.copy_logs.runner")
local count_sheep = require("nvim_builder._commands.goodnight_moon.count_sheep")
local lualine_require = require("lualine_require")
local modules = lualine_require.lazy_require({ highlight = "lualine.highlight" })
local read = require("nvim_builder._commands.goodnight_moon.read")
local say_runner = require("nvim_builder._commands.hello_world.say.runner")
local sleep = require("nvim_builder._commands.goodnight_moon.sleep")
local tabler = require("nvim_builder._core.tabler")
...
---@class nvim_builder.LualineConfiguration
---    The Raw user settings from lualine's configuration.
---    e.g. `require("lualine").setup { sections = { { "nvim_builder", ... }}}`
---    where "..." is the user's settings.
---@field display table<string, nvim_builder.LualineDisplayData>?

---@class nvim_builder.LualineDisplayData
---    Any text, icons, etc that will be displayed for `nvim_builder` commands.
---@field prefix string
...
---
---@param options nvim_builder.LualineConfiguration?
---    The options to pass from lualine to `plugin_templaet`.
---
function M:init(options)
    configuration.initialize_data_if_needed()

    --- @type table<string, nvim_builder.LualineDisplayData>
    local data
