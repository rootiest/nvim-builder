...
---
---@module 'nvim_builder._cli.cmdparse'
---

local argparse = require("nvim_builder._cli.argparse")
local argparse_helper = require("nvim_builder._cli.argparse_helper")
local configuration = require("nvim_builder._core.configuration")
local constant = require("nvim_builder._cli.cmdparse.constant")
local evaluator = require("nvim_builder._cli.cmdparse.evaluator")
local help_message = require("nvim_builder._cli.cmdparse.help_message")
local iterator_helper = require("nvim_builder._cli.cmdparse.iterator_helper")
local matcher = require("nvim_builder._cli.cmdparse.matcher")
local sorter = require("nvim_builder._cli.cmdparse.sorter")
local tabler = require("nvim_builder._core.tabler")
local text_parse = require("nvim_builder._cli.cmdparse.text_parse")
local texter = require("nvim_builder._core.texter")
local types_input = require("nvim_builder._cli.cmdparse.types_input")
...
---
---@param data nvim_builder.ConfigurationCmdparseAutoComplete?
...
---
---@param options nvim_builder.ConfigurationCmdparseAutoComplete?
---    The user settings to read from, if any. If no data is given, the user's
---    default configuration is used insteand.
