...
---
---@module 'nvim_builder._commands.copy_logs.runner'
---
...
---
---@param result nvim_builder.ReadFileResult The file path + its contents that we read.
---
...
---@class nvim_builder.ReadFileResult
...
---@param callback fun(result: nvim_builder.ReadFileResult): nil Call this once `path` is read.
---
