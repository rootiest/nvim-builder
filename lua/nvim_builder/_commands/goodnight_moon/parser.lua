--- The main parser for the `:NvimBuilder goodnight-moon` command.
---
---@module 'nvim_builder._commands.goodnight_moon.parser'
---
...
---@return cmdparse.ParameterParser # The main parser for the `:NvimBuilder goodnight-moon` command.
function M.make_parser()
    ...
    count_sheep:set_execute(function(data)
        ...
        local count_sheep_ = require("nvim_builder._commands.goodnight_moon.count_sheep")
    ...
    read:set_execute(function(data)
        ---@cast data nvim_builder.NamespaceExecuteArguments
        local read_ = require("nvim_builder._commands.goodnight_moon.read")
    ...
    sleep:set_execute(function(data)
        ---@cast data nvim_builder.NamespaceExecuteArguments
        local sleep_ = require("nvim_builder._commands.goodnight_moon.sleep")
