--- The main parser for the `:NvimBuilder hello-world` command.
---
---@module 'nvim_builder._commands.hello_world.parser'
---

local cmdparse = require("nvim_builder._cli.cmdparse")
local constant = require("nvim_builder._commands.hello_world.say.constant")
...
---@return cmdparse.ParameterParser # The main parser for the `:NvimBuilder hello-world` command.
function M.make_parser()
    ...
    phrase:set_execute(function(data)
        ...
        local runner = require("nvim_builder._commands.hello_world.say.runner")
