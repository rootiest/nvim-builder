...
---
---@module 'telescope._extensions.nvim_builder_'
---
...
vim.api.nvim_set_hl(0, "NvimBuilderTelescopeEntry", { link = "TelescopeResultsNormal", default = true })
vim.api.nvim_set_hl(0, "NvimBuilderTelescopeSecondary", { link = "TelescopeResultsComment", default = true })
            ...
            entry_maker = function(data)
                ...
                return {
                    display = function(entry)
                        return displayer({
                            { entry.name, "NvimBuilderTelescopeEntry" },
                            { entry.author, "NvimBuilderTelescopeSecondary" },
                        })
                    end,
                    author = author,
                    name = name,
