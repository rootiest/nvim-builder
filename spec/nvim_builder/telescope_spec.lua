...
---
---@module 'nvim_builder.telescope_spec'
---

local mock_test = require("test_utilities.mock_test")
local nvim_builder = require("telescope._extensions.nvim_builder")
...
---    nvim_builder foo` then this function would require `"foo"`.
---
local function _make_telescope_picker(command)
    nvim_builder.exports[command]()
